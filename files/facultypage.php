    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">10:50-11:40</td>
                <td style="text-align:center">11:40-12:30</td>
                <td style="text-align:center">1:20-2:10</td>
                <td style="text-align:center">2:10-3:00</td>
            </tr>
            <tr>
                <?php
                $table = null;
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER ENGINEERING DEPARTMENT, PEC.";
